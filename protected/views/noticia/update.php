...
$this->breadcrumbs=array(
	...
	Yii::t('app', $model->id_noticia) => array('view', 'id'=>$model->id_noticia),
...
$this->menu=array(
	...
	//array('label' => Yii::t('AweCrud.app', 'View'), 'icon' => 'eye-open', 'url'=>array('view', 'id' => $model->id_noticia)),
...
<fieldset>
    <legend><?php echo Yii::t('AweCrud.app', 'Update') . ' ' . Noticia::label(); ?> <?php echo CHtml::encode($model) ?></legend>
