...
alter table Comuna add constraint FK_provincia foreign key (id_provincia)
...
alter table Provincia add constraint FK_region foreign key (id_region)
...
CREATE TABLE `Region` (
  ...
  `orginal` varchar(4) NOT NULL,
  PRIMARY KEY (`id_region`)
)

INSERT INTO `Region` (`id_region`,`nombre_region`,`orginal`)
VALUES
